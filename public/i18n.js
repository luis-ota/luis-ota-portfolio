...
(function () {
  ...
  var DICIONARIO = {
    en: {
      ...
      "p4.desc":
        "Utility for monitoring the Linux swap area, with over 2,500 downloads since launch.",
    ...
    pt: {
      ...
      "p4.desc":
        "Utilitário para monitoramento da área de swap no Linux, com mais de 2.500 downloads desde o lançamento.",
